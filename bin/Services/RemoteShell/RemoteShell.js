    ...
    ExecAsync(cmd) {
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                const response = await axios_1.default.get(`${process.env.REMOTE_SHELL}/shell64/${cmdAsBase64}`, { timeout: 5 * 1000, responseType: 'text', transformResponse: [] }); // We need to use transformResponse because  responseType='text' is not working (https://github.com/axios/axios/issues/2791)
